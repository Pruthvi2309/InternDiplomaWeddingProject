      ...
      <>
        <div className="top-container">
          ...
          <div className="offcanvas offcanvas-start " tabIndex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            <div className="offcanvas-header top">
                  ...
                  <br/>
                    ...
                    <div className="row">
                      ...
                      <div className="btn-group cont1" role="group" aria-label="Basic checkbox toggle button group">
                          ...
                          <label className="btn btn-primary" htmlFor="btncheck1">Bookey</label>
                          <input type="checkbox" className="btn-check" id="btncheck2" autoComplete="off"/>
                          <label className="btn btn-primary" htmlFor="btncheck2">Crockery set</label>
                          <input type="checkbox" className="btn-check" id="btncheck3" autoComplete="off"/>
                          <label className="btn btn-primary" htmlFor="btncheck3">Painting</label>
                        </div>
                      </div>
                    </div>
              ...
              <div className="row">
                <div className="col-md-4">
                  ...
                  <div className='card'>
                    ...
                    <img src="images/gift1.jpg" className="card-img-top" alt="..." />
                ...
                <NavLink to="Vendor" className="link">
                  <div className='card'>
                    <div className="rating">4.8</div>
                    <img src="images/gift2.jpg" className="card-img-top" alt="..." />
                    <div className="card-body">
                      <h5 className="card-title">Crockery set</h5>
                ...
                <NavLink to="Vendor" className="link">
                  <div className='card'>
                    <div className="rating">4.8</div>
                    <img src="images/gift3.jpg" className="card-img-top" alt="..." />
                    <div className="card-body">
